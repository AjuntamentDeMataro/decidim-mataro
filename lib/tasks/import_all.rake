...
namespace :import do
  task :all => :environment do
    ...
    Decidim::Organization.create!(
      name: "www.decidimmataro.cat",
      host: "decidim-mataro.herokuapp.com",
      ...
      welcome_text: {
        ca: "Decidim la Mataró que volem",
        es: "Decidamos la Mataró que queremos"
      },
      description: {
        ca: "Benvingut/da a la plataforma de participació de Mataró.
Construïm una ciutat més oberta, transparent i col·laborativa.
Entra, participa i decideix",
        es: "Bienvenido/a a la plataforma de participación de Mataró.
