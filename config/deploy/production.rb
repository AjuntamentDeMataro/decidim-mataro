...
set :deploy_to, '/var/www/vhosts/decidim-mataro'
set :branch, 'master'
set :rails_env, :production

role :app, %w{deployer1@szl9.zlworks.com}
role :web, %w{deployer1@szl9.zlworks.com}
role :db,  %w{deployer1@szl9.zlworks.com}
